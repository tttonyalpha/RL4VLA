...
class RecordEpisode(gym.Wrapper):
    ...
    def __init__(
        ...
        self.recording_camera_name = recording_camera_name
    ...
    def capture_image(self, infos=None):
        if self.recording_camera_name:
            img = self.env.unwrapped.get_obs()["sensor_data"][self.recording_camera_name]["rgb"].to(torch.uint8)
        else:
            img = self.env.render()
